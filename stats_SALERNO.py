...
## Progressiva chilometrica tra due tracce uguale 0 (con dati GPS diversi)
...
viasat_anomaly_234 = pd.read_sql_query('''
                       SELECT
                          idterm, anomaly
                         FROM routecheck_2019
                         WHERE  anomaly LIKE '%234%' ''', conn_HAIG)
### hom many ......
viasat_anomaly_234 = (len(viasat_anomaly_234) / N ) *100
