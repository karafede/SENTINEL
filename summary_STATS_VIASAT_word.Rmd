...
p <- ggplot(joined_ANAS_VIASAT_grezzi, aes(x=ratio, fill=direzione)) +
    ...
    ggtitle("Coefficiente di penetrazione tra dati VIASAT e dati ANAS (31 Ago.-18 Sett. 2019)") +
