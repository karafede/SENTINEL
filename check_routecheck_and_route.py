...
with open("D:/ENEA_CAS_WORK/SENTINEL/viasat_data/all_idterms.txt", "r") as file:
...
with open("D:/ENEA_CAS_WORK/SENTINEL/viasat_data/all_idterms_new.txt", "w") as file:
...
## reload 'all_idterms' as list
with open("D:/ENEA_CAS_WORK/SENTINEL/viasat_data/idterms.txt", "r") as file:
    all_ID_TRACKS = eval(file.readline())
print(len(all_ID_TRACKS))
## make difference between all idterm and processed idterms
...
# ## save 'all_ID_TRACKS' as list
with open("D:/ENEA_CAS_WORK/SENTINEL/viasat_data/idterms_new.txt", "w") as file:
    file.write(str(all_ID_TRACKS_DIFF))
