...
p <- ggplot(data = STATS_passaggi_daily_SALERNO,
    ...
    ggtitle("Numero totale di passaggi per giorno della settimana (--> Salerno) (ANAS, 1-18 Sett. 2017)") + 
...
p <- ggplot(data = STATS_passaggi_daily_AVELLINO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=45, vjust=1, size=10)) +
    geom_text(aes(label = paste(norm_conteggi, sep = "")), size = 3, hjust = 0.5, col = "#ffffff",  vjust = 1) +
    ggtitle("Numero totale di passaggi per giorno della settimana (<-- Avellino) (1-18 Sett, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
p <- ggplot(data = STATS_passaggi_hourly_SALERNO,
    ...
    ggtitle("Numero totale di passaggi orari nei giorni feriali (--> Salerno) (1-18 Sett. 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
p <- ggplot(data = STATS_passaggi_hourly_AVELLINO,
   ...
   scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni feriali (<-- Avellino) (1-18 Sett. 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
p <- ggplot(data = STATS_passaggi_hourly_SALERNO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=0, vjust=0.5, size=8, hjust = 0.5)) + # 
    scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni festivi (--> Salerno) (1-18 Sett. 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
p <- ggplot(data = STATS_passaggi_hourly_AVELLINO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=0, vjust=0.5, size=8, hjust = 0.5)) + # hjust = 0.5
   scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni festivi (<-- Avellino) (1-18 Sett. 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
