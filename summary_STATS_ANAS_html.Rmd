...
p <- ggplot(data = STATS_passaggi_daily_SALERNO,
    ...
    ggtitle("Numero totale di passaggi per giorno della settimana (--> Salerno) (ANAS, 1-18 Settembre 2017)") + 
...
p <- ggplot(data = STATS_passaggi_hourly_SALERNO,
    ...
    ggtitle("Numero totale di passaggi per ora della giornata (--> Salerno) (1-18 Settembre 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
p <- ggplot(data = STATS_passaggi_hourly_AVELLINO,
   ...
   scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi per ora della giornata (<-- Avellino) (1-18 Settembre 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
q <- ggplot(data = STATS_passaggi,
  ...
  ggtitle("Numero di passaggi totali (tutti i veicoli, 1-18 Settembre 2017)") +
...
q <- ggplot(data = STATS_passaggi, 
  ...
  geom_text(aes(label = paste(norm_conteggi, sep = "")), size = 3, hjust = 0.5, vjust = -0.5) +
  ggtitle("Numero totale di passaggi per corsia di marcia e per classi di autoveicoli (1-18 Settembre 2017)") + 
...
q <- ggplot(data = STATS_velocita, 
  ...
  ggtitle("Velocita' per classi (1-18 Settembre 2017)") + 
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=7, fig.cap ="**Figura 11a.** Distribuzione delle velocita' istantanee per classe di autoveicoli su un tratto dell'autostrada A2 (1-18 Settembre 2017; Salerno)."}
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=7, fig.cap ="**Figura 11b.** Distribuzione delle velocita' istantanee per classe di autoveicoli su un tratto dell'autostrada A2 (1-18 Settembre 2017; Avellino)."}
