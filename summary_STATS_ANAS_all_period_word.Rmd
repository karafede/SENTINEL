---
title: "Analisi dati ANAS A2 Km5+004 (2017)" 
author:
- Federico Karagulian
...
# min(DB$fine_periodo_di_aggregazione)
# max(DB$fine_periodo_di_aggregazione)
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura1.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 2.** Serie temporale della somma giornaliera di tutti i passaggi sull'autostrada A2 (km5+004) direzione Salerno. La somma e' riferita a tutti i tipi di autoveicoli (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura2.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 3.** Serie temporale oraria del numero di passaggi per tutti i tipi di autoveicoli sull'autostrada A2 (km5+004) direzione Avellino (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura3.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap = "**Figura 4.** Serie temporale della somma giornaliera di tutti i passaggi sull'autostrada A2 (km5+004) direzione Avellino La somma e' riferita a tutti i tipi di autoveicoli (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura4.png")
...
p <- ggplot(data = STATS_passaggi_daily_SALERNO,
    ...
    ggtitle("Numero totale di passaggi per giorno della settimana (--> Salerno, 2017)") + 
...
p <- ggplot(data = STATS_passaggi_daily_AVELLINO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=45, vjust=1, size=10)) +
    geom_text(aes(label = paste(norm_conteggi, sep = "")), size = 3, hjust = 0.5, col = "#ffffff",  vjust = 1) +
    ggtitle("Numero totale di passaggi per giorno della settimana (<-- Avellino, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 4e.** Numero di passaggi orari per giorni feriali e per classe di autoveicoli sul tratto dell'autostrada A2 (km5+004) nella direzione verso Salerno (2017)."}
...
p <- ggplot(data = STATS_passaggi_hourly_SALERNO,
    ...
    ggtitle("Numero totale di passaggi orari nei giorni feriali (--> Salerno, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 4f.**  Numero di passaggi orari per giorni feriali e per classe di autoveicoli sul tratto dell'autostrada A2 (km5+004) nella direzione verso Avellino (2017)."}
...
p <- ggplot(data = STATS_passaggi_hourly_AVELLINO,
   ...
   scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni feriali (<-- Avellino, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 4g.** Numero di passaggi orari per giorni festivi e per classe di autoveicoli sul tratto dell'autostrada A2 (km5+004) nella direzione verso Salerno (2017)."}
...
p <- ggplot(data = STATS_passaggi_hourly_SALERNO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=0, vjust=0.5, size=8, hjust = 0.5)) + # 
    scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni festivi (--> Salerno, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 4h.**  Numero di passaggi orari per giorni festivi e per classe di autoveicoli sul tratto dell'autostrada A2 (km5+004) nella direzione verso Avellino (2017)."}
...
p <- ggplot(data = STATS_passaggi_hourly_AVELLINO,
    ...
    theme(axis.title.x = element_text(face="bold", colour="black", size=12),
          axis.text.x  = element_text(angle=0, vjust=0.5, size=8, hjust = 0.5)) + # hjust = 0.5
   scale_x_continuous(breaks=c(0, 5, 10, 15, 20)) +
    ggtitle("Numero totale di passaggi orari nei giorni festivi (<-- Avellino, 2017)") + 
    theme(plot.title = element_text(lineheight=.8, face="bold"))
  p
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Figura 5.** Numero di passaggi totali per classe di autoveicoli sul tratto dell'autostrada A2 (km5+004). I numeri all'interno del grafico indicano la distribuzione percentuale per classi di veicolo del numero di passaggi sulle due direzioni di marcia: --> Salerno e <-- Avellino (2017)."}
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=6, fig.cap ="**Figura 7.** Numero totale di passaggi per classe di autoveicoli e per corsia di marcia sul tratto dell'autostrada A2 (km5+004). I numeri all'interno del grafico indicano la distribuzione percentuale, per classi di veicolo (2017)."}
...
q <- ggplot(data = STATS_passaggi, 
  ...
  ggtitle("Numero totale di passaggi per corsia di marcia e per classi di autoveicoli (2017)") + 
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5, fig.cap ="**Figura 8.** Velocita' media oraria e per corsia di marcia di tutti i veicoli in transito sul tratto dell'autostrada A2 (km5+004) direzione Salerno (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura8.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5, fig.cap ="**Figura 9.** Velocita' media oraria e per corsia di marcia di tutti i veicoli in transito sul tratto dell'autostrada A2 (km5+004) direzione Avellino (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura9.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5, fig.cap ="**Figura 10.** Velocita' armonica oraria e per corsia di marcia di tutti i veicoli in transito sul tratto dell'autostrada A2 (km5+004) direzione Salerno (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura10.png")
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5, fig.cap ="**Figura 10a.** Velocita' armonica oraria e per corsia di marcia di tutti i veicoli in transito sul tratto dell'autostrada A2 (km5+004) direzione Avellino (2017)."}
...
knitr::include_graphics("D:/ENEA_CAS_WORK/SENTINEL/ANAS/Figura10a.png")
...
q <- ggplot(data = STATS_velocita, 
  ...
  ggtitle("Velocita' per classi (2017)") + 
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=7, fig.cap ="**Figura 12.** Distribuzione delle velocita' istantanee per classe di autoveicoli su un tratto dell'autostrada A2 (2017; Salerno)."}
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=7, fig.cap ="**Figura 12a.** Distribuzione delle velocita' istantanee per classe di autoveicoli su un tratto dell'autostrada A2 (2017; Avellino)."}
...
````{r, message = FALSE, echo = FALSE, warning = FALSE, fig.width=9,fig.height=5,  fig.cap ="**Tabella AAA.**"}
...
# library(fitdistrplus)
# ## fit with a "gaussian/normal" distribution
# fit_ANAS <- fitdistrplus::fitdist(velocita_ANAS$velocità, "norm")
...
# 
# 
# Caption <- paste0("**Tabella 3.** Parametri ottenuti dalla modellizzazione della distribuzione delle **velocità instantanee** con una distribuzione gaussiana. I parametri di valore medio e di deviazione standard sono riportati per automobli e veicoli pesanti.")
# set.caption(Caption)
# panderOptions("table.emphasize.rownames", FALSE) # remove row.names from the table
# panderOptions("table.split.table", Inf) # to avoid to split tables if rows are too long
# panderOptions('table.alignment.default', function(df) ifelse(sapply(df, is.numeric), 'right', 'left')) # right alignment for numeric, left otherwise
# pander(fit_ANAS, emphasize.strong.cols = 1, missing = "")
